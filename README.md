This is a simple character controller using the Third Person Character controller in Unity modified to work with the IK system to create a Full Body Awareness controller.
